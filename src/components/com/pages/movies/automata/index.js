...
import * as data from 'com/entities/movie/data'; 
...
export const fetchData = createAsyncThunk(`${MODEL_NAME}/fetchData`,
  async ( params, thunkAPI ) => {
    ...
    return ( params.renderer !== 'banner' ) ? await data.fetchDashboard({dataEntity: "Movies"}) : { data : null, loading: false, error: null }
  }
)
