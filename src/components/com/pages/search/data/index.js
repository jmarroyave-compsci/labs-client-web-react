...
export const fetchResults = ( qry, page, entities ) => fetch( QRY_RESULTS, { qry: qry, page: page, entities: encodeURIComponent(JSON.stringify(entities, null, 0))  } , (resp) => { return { ...resp, data: resp.data.searchResults } } )
