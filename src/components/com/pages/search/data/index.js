...
export const fetchResults = ( { qry, page, entities, year, timeFrame } ) => fetch( QRY_RESULTS, { qry: qry, page: page, entities: encodeURIComponent(JSON.stringify(entities, null, 0)), year: parseInt(year), timeframe: parseInt(timeFrame)  } , (resp) => { return { ...resp, data: resp.data.search } } )
