...
export const fetchItems = ( { page, entity, genre, decade, nratio } ) => fetch( GET_DATA( { ENTITY: entity.replace(/-/g, "_") } ), { page: page, year: decade.toString(), genre: genre, nratio: nratio } , (resp) => { return { ...resp, data: resp.data.storyTopics } } )

const GET_DATA = ( { ENTITY } ) => gql`
query ${ENTITY}_topics($page: Int, $genre: String, $year: String, $nratio : Int){
